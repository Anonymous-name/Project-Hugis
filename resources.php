		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4 col-md-6">
					<div class="single-latest-news">
						<div class="tool-title">
							<h3><a href="single-news.html">Evacuation Centers</a></h3>
						</div>
						<div class="news-text-box-1">
							<a href="single-news.html"><div class="latest-news-bg-1 news-bg-1"></div></a>
						</div>
					</div>
				</div>
				<div class="col-lg-4 col-md-6">
					<div class="single-latest-news">
						<div class="tool-title">
							<h3><a href="single-news.html">Brgy Municipal Hall</a></h3>
						</div>
						<div class="news-text-box-1">
							<a href="single-news.html"><div class="latest-news-bg-1 news-bg-1"></div></a>
						</div>
				...
				<div class="col-lg-4 col-md-6">
					<div class="single-latest-news">
						<div class="tool-title">
							<h3><a href="single-news.html">Brgy. Boundaries </a></h3>
						</div>
						<div class="news-text-box-1">
							<a href="single-news.html"><div class="latest-news-bg-1 news-bg-1"></div></a>
						</div>
				...
				<div class="col-lg-4 col-md-6">
					<div class="single-latest-news">
						<div class="tool-title">
							<h3><a href="single-news.html">Hospital</a></h3>
						</div>
						<div class="news-text-box-1">
							<a href="single-news.html"><div class="latest-news-bg-1 news-bg-1"></div></a>
						</div>
				...
				<div class="col-lg-4 col-md-6">
					<div class="single-latest-news">
						<div class="tool-title">
							<h3><a href="single-news.html">Schools</a></h3>
						</div>
						<div class="news-text-box-1">
							<a href="single-news.html"><div class="latest-news-bg-1 news-bg-1"></div></a>
						</div>
				...
				<div class="col-lg-4 col-md-6">
					<div class="single-latest-news">
						<div class="tool-title">
							<h3><a href="single-news.html">Road Networks</a></h3>
						</div>
						<div class="news-text-box-1">
							<a href="single-news.html"><div class="latest-news-bg-1 news-bg-1"></div></a>
						</div>
